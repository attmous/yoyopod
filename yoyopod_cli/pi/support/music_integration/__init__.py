...
from yoyopod_cli.pi.support.music_integration.handlers import (
...
from yoyopod_cli.pi.support.music_integration.history import RecentTrackHistoryStore
from yoyopod_cli.pi.support.music_integration.history import RecentTrackEntry
from yoyopod_cli.pi.support.music_integration.library import LocalLibraryItem, LocalMusicService
...
def __getattr__(name: str) -> Any:
    ...
    if name in {"MusicFSM", "MusicState"}:
        from yoyopod_cli.pi.support.music_integration.fsm import MusicFSM, MusicState
...
def setup(
    ...
    *,
    ...
    from yoyopod_cli.pi.support.music_backend.rust_host import RustHostBackend, default_worker_path
