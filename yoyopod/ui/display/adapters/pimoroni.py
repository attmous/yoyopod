            ...
            if gpio_config is None or gpio_config.dc is None or gpio_config.backlight is None:
                ...
                try:
                    self.device = ST7789SpiDriver(
                        ...
                        cs_chip=(gpio_config.cs.chip if gpio_config.cs is not None else gpio_config.dc.chip),
                        cs_line=(gpio_config.cs.line if gpio_config.cs is not None else gpio_config.dc.line),
