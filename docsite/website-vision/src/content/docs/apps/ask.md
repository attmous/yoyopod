...
:::note[Sources]
Condensed from [docs/features/CLOUD_VOICE_WORKER.md](https://github.com/attmous/yoyopod/blob/main/docs/features/CLOUD_VOICE_WORKER.md) and the as-built docs site (docsite/website/ in the repository): the screens and navigation page, the cloud voice worker runbook, and the speech interpreter profile.
:::
