...
[Speech Engine](/builders/software/speech-engine/).
...
- The deep dive — the FFI ledger, the render loop, the tracked gaps — is the as-built UI System Guide in the engineering docs (`docsite/website/` in the repository). This page stays the map; that guide stays the territory.
