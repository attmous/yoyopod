...
import MediaPaths from '../../../../assets/diagrams/media-paths.svg';
...
:::note[Sources]
Condensed from [`docs/features/LOCAL_FIRST_MUSIC_PLAN.md`](https://github.com/attmous/yoyopod/blob/main/docs/features/LOCAL_FIRST_MUSIC_PLAN.md), [`docs/features/MPV_DEPENDENCIES.md`](https://github.com/attmous/yoyopod/blob/main/docs/features/MPV_DEPENDENCIES.md), and [`docs/features/REMOTE_PLAYBACK.md`](https://github.com/attmous/yoyopod/blob/main/docs/features/REMOTE_PLAYBACK.md), and the as-built docs site (docsite/website/ in the repository): the media worker page, Local-First Music, MPV Dependencies, and Remote Playback.
:::
