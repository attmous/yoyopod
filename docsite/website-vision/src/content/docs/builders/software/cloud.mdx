...
import CloudTwoFaces from '../../../../assets/diagrams/cloud-two-faces.svg';
...
*Design direction — not built yet.* The build-vs-adopt
...
:::note[Sources]
Condensed from [`docs/features/CLOUD_PROVISIONING_AND_BACKEND.md`](https://github.com/attmous/yoyopod/blob/main/docs/features/CLOUD_PROVISIONING_AND_BACKEND.md) and [`docs/features/CLOUD_VOICE_WORKER.md`](https://github.com/attmous/yoyopod/blob/main/docs/features/CLOUD_VOICE_WORKER.md), and the as-built docs site (`docsite/website/` in the repository): the cloud worker profile, the cloud provisioning and backend page, and the cloud voice worker runbook.
:::
