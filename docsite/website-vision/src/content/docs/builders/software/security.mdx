...
import UpdateTrust from '../../../../assets/diagrams/update-trust.svg';
...
from the as-built docs site (`docsite/website/` in the repository): the cloud
