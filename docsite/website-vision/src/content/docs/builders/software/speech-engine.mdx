...
import AskRoundTrip from '../../../../assets/diagrams/ask-round-trip.svg';
...
- **Adopt the permanent "no always-listening, ever" commitment** and record it in [principles](/company/principles/), closing the wake-word question for good — or keep it open.
...
:::note[Sources]
Condensed from [`docs/features/CLOUD_VOICE_WORKER.md`](https://github.com/attmous/yoyopod/blob/main/docs/features/CLOUD_VOICE_WORKER.md) and the as-built docs site (docsite/website/ in the repository): the speech worker profile, the cloud voice worker runbook, and the screens and navigation page.
:::
